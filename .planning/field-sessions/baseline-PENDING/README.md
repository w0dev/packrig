...
This directory is committed only so the `.planning/field-sessions/` tree is visible before any controller extraction begins. The actual baseline directory MUST be named `baseline-<YYYY-MM-DD>/` (UTC date of capture) — it replaces this placeholder.
