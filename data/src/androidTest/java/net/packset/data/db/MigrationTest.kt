...
class MigrationTest {
    ...
    fun migrate1To2_preservesRowsAndAddsNullParkColumn() {
        ...
        helper.runMigrationsAndValidate(DB_NAME, 2, true, PacksetDatabase.MIGRATION_1_2).use { db ->
    ...
    fun migrate2To3_existingRowsBecomeNotQueued() {
        ...
        helper.runMigrationsAndValidate(DB_NAME, 3, true, PacksetDatabase.MIGRATION_2_3).use { db ->
