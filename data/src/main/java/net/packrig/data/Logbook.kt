...
import net.packrig.data.adif.AdifImportMerge
import net.packrig.data.adif.AdifWriter
import net.packrig.data.db.PackRigDatabase
import net.packrig.data.db.QrzUploadState
import net.packrig.data.db.QsoEntity
import net.packrig.data.model.QsoContact
import net.packrig.data.qrz.QrzQueueStore
import net.packrig.data.qrz.RoomQrzQueueStore
...
class RoomLogbook(db: PackRigDatabase) : Logbook {
