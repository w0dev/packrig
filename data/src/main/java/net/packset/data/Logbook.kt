package net.packset.data

import net.packset.data.adif.AdifExportContext
import net.packset.data.adif.AdifImportMerge
import net.packset.data.adif.AdifWriter
import net.packset.data.db.PacksetDatabase
import net.packset.data.db.QrzUploadState
import net.packset.data.db.QsoEntity
import net.packset.data.model.QsoContact
import net.packset.data.qrz.QrzQueueStore
import net.packset.data.qrz.RoomQrzQueueStore
...
class RoomLogbook(db: PacksetDatabase) : Logbook {
