...
/**
 * Test-side seam Phase 5's TxOrchestrator will depend on. Production
 * `UsbAudioPlayback` is currently a concrete class with no interface; Phase 5
 * will introduce a matching production interface and bridge it. For Phase 0,
 * only the fake exists, and consumers in later phases inject this interface
 * directly.
 */
interface UsbAudioPlaybackFake {
