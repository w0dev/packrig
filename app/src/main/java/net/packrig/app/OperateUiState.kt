...
import net.packrig.app.controllers.QrzSlice
...
data class DecodeRow(
    ...
    val source: net.packrig.core.DecodeRowSource = net.packrig.core.DecodeRowSource.Rx,
    /** Whether the sender's callsign has been worked before. */
    val workedBefore: net.packrig.core.WorkedBefore = net.packrig.core.WorkedBefore.Never,
    /**
     ...
     * pixel-identically.
     */
    val passSource: net.packrig.core.DecodePassSource = net.packrig.core.DecodePassSource.Full,
)
