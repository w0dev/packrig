...
import net.packset.audio.AudioInputDevice
...
data class DecodeRow(
    ...
    val source: net.packset.core.DecodeRowSource = net.packset.core.DecodeRowSource.Rx,
    /** Whether the sender's callsign has been worked before. */
    val workedBefore: net.packset.core.WorkedBefore = net.packset.core.WorkedBefore.Never,
    /**
     ...
     * pixel-identically.
     */
    val passSource: net.packset.core.DecodePassSource = net.packset.core.DecodePassSource.Full,
)
