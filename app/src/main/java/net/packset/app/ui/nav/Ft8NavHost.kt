...
import net.packset.app.LogViewModel
import net.packset.app.OperateViewModel
import net.packset.app.SnackbarEvent
import net.packset.app.SnackbarThrottle
import net.packset.app.settings.SettingsScreen
import net.packset.app.ui.log.LogScreen
import net.packset.app.ui.operate.OperateScreen
import net.packset.app.ui.spectrum.SpectrumScreen
import net.packset.app.ui.theme.PacksetTheme
...
fun PacksetApp(
    ...
    PacksetTheme(darkTheme = operateState.useDarkTheme) {
        Scaffold(
