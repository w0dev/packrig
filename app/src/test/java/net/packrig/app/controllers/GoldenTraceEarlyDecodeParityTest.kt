 ...
 *
 * The existing golden-trace harness ([net.packrig.app.foundations.golden.GoldenTraceReplay])
 * exercises [net.packrig.core.QsoMachine] directly. It feeds canned [net.packrig.core.QsoDecode]
