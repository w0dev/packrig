 ...
 *
 * The existing golden-trace harness ([net.packset.app.foundations.golden.GoldenTraceReplay])
 * exercises [net.packset.core.QsoMachine] directly. It feeds canned [net.packset.core.QsoDecode]
